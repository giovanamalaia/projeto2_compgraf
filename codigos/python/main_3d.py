...
def initialize (win):
  ...
  shd_tex.AttachVertexShader("codigos/python/shaders/ilum_vert/vertex_texture.glsl")
  shd_tex.AttachFragmentShader("codigos/python/shaders/ilum_vert/fragment_texture.glsl")
  shd_tex.Link()
  sphere = Sphere()
  try:
      sun_tex = Texture("uTexture", "/Users/giovanamalaia/Downloads/Material Puc/COMPGRAF/Projeto 2/codigos/python/images/earth2.jpg")
      earth_tex = Texture("uTexture", "/Users/giovanamalaia/Downloads/Material Puc/COMPGRAF/Projeto 2/codigos/python/images/earth2.jpg")
      moon_tex = Texture("uTexture", "/Users/giovanamalaia/Downloads/Material Puc/COMPGRAF/Projeto 2/codigos/python/images/earth2.jpg")
      mercury_tex = Texture("uTexture", "/Users/giovanamalaia/Downloads/Material Puc/COMPGRAF/Projeto 2/codigos/python/images/earth2.jpg")
  except Exception as e:
      print(f"Erro ao carregar texturas: {e}")
      print("Verifique os caminhos dos arquivos de imagem (sun.jpg, earth.jpg, etc.).")
      glfw.terminate()
      sys.exit()
  ...
  mercury_spin_engine = SpinEngine3D(
      trf_mercury_spin, 
      0.5, 
  ...
  earth_spin_engine = SpinEngine3D(
      trf_earth_spin, 
      2.0, 
  ...
  root = Node(shd_tex, 
      nodes = [
          Node(shd_tex, trf_sun_spin, [white, sun_tex], [sphere],
              nodes = [
                  Node(None, trf_mercury_orbit,
                      nodes = [
                          Node(None, trf_mercury_translate,
                              nodes = [
                                  Node(shd_tex, trf_mercury_spin, [white, mercury_tex], [sphere])
                              ]
                          )
                      ]
                  ),
                  Node(None, trf_earth_orbit,
                      nodes = [
                          Node(None, trf_earth_translate,
                              nodes = [
                                  Node(shd_tex, trf_earth_spin, [white, earth_tex], [sphere],
                                      nodes = [
                                          Node(None, trf_moon_orbit,
                                              nodes = [
                                                  Node(None, trf_moon_translate,
                                                      nodes = [
                                                          Node(shd_tex, trf_moon_spin, [white, moon_tex], [sphere])
                                                      ]
                                                  )
                                              ]
                                          )
